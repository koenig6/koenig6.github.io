...
weatherObject.onload = function () {
    ...
    document.getElementById('high').innerHTML = weatherObjectInfo.current_observation.temp_f;
    document.getElementById('wet').innerHTML = weatherInfo.current_observation.weather;
    document.getElementById('speed').innerHTML = weattherInfo.current_observation.wind_mph;
